...
enum HTMLTemplates {
    static func article(_ metadata: ArticleMetadata) -> String {
        return """
        <!DOCTYPE html><html><head><meta charset="utf-8"><link rel="shortcut icon" href="/favicon.ico"><link rel="icon" sizes="16x16 32x32 64x64" href="/favicon.ico"><link rel="icon" type="image/png" sizes="196x196" href="/favicon-192.png"><link rel="icon" type="image/png" sizes="160x160" href="/favicon-160.png"><link rel="icon" type="image/png" sizes="96x96" href="/favicon-96.png"><link rel="icon" type="image/png" sizes="64x64" href="/favicon-64.png"><link rel="icon" type="image/png" sizes="32x32" href="/favicon-32.png"><link rel="icon" type="image/png" sizes="16x16" href="/favicon-16.png"><link rel="apple-touch-icon" href="/favicon-57.png"><link rel="apple-touch-icon" sizes="114x114" href="/favicon-114.png"><link rel="apple-touch-icon" sizes="72x72" href="/favicon-72.png"><link rel="apple-touch-icon" sizes="144x144" href="/favicon-144.png"><link rel="apple-touch-icon" sizes="60x60" href="/favicon-60.png"><link rel="apple-touch-icon" sizes="120x120" href="/favicon-120.png"><link rel="apple-touch-icon" sizes="76x76" href="/favicon-76.png"><link rel="apple-touch-icon" sizes="152x152" href="/favicon-152.png"><link rel="apple-touch-icon" sizes="180x180" href="/favicon-180.png"><meta name="msapplication-TileColor" content="#FFFFFF"><meta name="msapplication-TileImage" content="/favicon-144.png"><meta name="msapplication-config" content="/browserconfig.xml"><link rel="stylesheet" href="../styles/fonts.css"><link rel="stylesheet" href="../styles/main.css"><link rel="stylesheet" href="../styles/swift.css"><link rel="stylesheet" href="../styles/shell.css"><meta name="viewport", content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=0"><meta property="og:type" content="website"><meta property="og:url" content="https://faical.dev/articles/\(metadata.id).html"><meta property="og:title" content="\(metadata.title)"><meta property="og:description" content="\(metadata.markdownAbstract)"><meta property="og:image" content="https://faical.dev/assets/cards/\(metadata.id).png"><meta name="twitter:card" content="summary_large_image"><meta name="twitter:domain" value="faical.dev"><meta name="twitter:title" value="\(metadata.title)"><meta name="twitter:description" value="\(metadata.markdownAbstract)">\(creationDateMetaTag(metadata))<meta name="twitter:image" content="https://faical.dev/assets/cards/\(metadata.id).png"><title>\(metadata.title)</title></head><body><div class="container">\(metadata.htmlContent)\(socialMediaSharingLinkTags(metadata))<br><hr noshade><div class="footer"><span class="cta"><a href="/">Back to all articles</a></span>\(creationDateLinkTag(metadata))</div></div></body></html>
        """
    }

    static func home(articles: [ArticleMetadata]) -> String {
        return """
        <!DOCTYPE html><html><head><meta charset="utf-8"><link rel="shortcut icon" href="/favicon.ico"><link rel="icon" sizes="16x16 32x32 64x64" href="/favicon.ico"><link rel="icon" type="image/png" sizes="196x196" href="/favicon-192.png"><link rel="icon" type="image/png" sizes="160x160" href="/favicon-160.png"><link rel="icon" type="image/png" sizes="96x96" href="/favicon-96.png"><link rel="icon" type="image/png" sizes="64x64" href="/favicon-64.png"><link rel="icon" type="image/png" sizes="32x32" href="/favicon-32.png"><link rel="icon" type="image/png" sizes="16x16" href="/favicon-16.png"><link rel="apple-touch-icon" href="/favicon-57.png"><link rel="apple-touch-icon" sizes="114x114" href="/favicon-114.png"><link rel="apple-touch-icon" sizes="72x72" href="/favicon-72.png"><link rel="apple-touch-icon" sizes="144x144" href="/favicon-144.png"><link rel="apple-touch-icon" sizes="60x60" href="/favicon-60.png"><link rel="apple-touch-icon" sizes="120x120" href="/favicon-120.png"><link rel="apple-touch-icon" sizes="76x76" href="/favicon-76.png"><link rel="apple-touch-icon" sizes="152x152" href="/favicon-152.png"><link rel="apple-touch-icon" sizes="180x180" href="/favicon-180.png"><meta name="msapplication-TileColor" content="#FFFFFF"><meta name="msapplication-TileImage" content="/favicon-144.png"><meta name="msapplication-config" content="/browserconfig.xml"><link rel="stylesheet" href="styles/fonts.css"><link rel="stylesheet" href="styles/main.css"><link rel="stylesheet" href="styles/swift.css"><link rel="stylesheet" href="styles/shell.css"><meta name="viewport", content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=0"><meta property="og:url" content="https://faical.dev"><meta property="og:title" content="Faiçal's Personal Blog"><meta property="og:description" content="Articles about Swift, software engineering, best practices, books, life, the universe and everything." /><meta name="twitter:card" content="summary"><meta name="twitter:domain" value="faical.dev"><meta name="twitter:title" value="Faiçal's Personal Blog"><meta name="twitter:description" value="Articles about Swift, software engineering, best practices, books, life, the universe and everything."><title>Faiçal's Personal Blog</title></head><body><div class="intro"><img class="profile-pic" src="assets/me.jpg"><div class="bio"><p>Hi 👋! My name is <a href="https://twitter.com/ftchirou">Faiçal Tchirou</a>. I'm a software engineer currently living in Berlin 🇩🇪. I write code mostly in <a href="https://docs.swift.org/swift-book/">Swift</a> on and for Apple platforms. If you've ever used the Microsoft Azure SDKs for <a href="https://github.com/Azure/Azure.iOS/pulls?q=is%3Apr+author%3Aftchirou+is%3Aclosed">iOS</a> and/or <a href="https://github.com/Azure/Azure.Android/pulls?q=is%3Apr+author%3Aftchirou+is%3Aclosed">Android</a> or Apple's <a href="https://github.com/apple/swift/pulls?q=is%3Apr+author%3Aftchirou+is%3Aclosed">libSyntax</a>, then you've used code that I wrote :).</p><p>This is <a href="https://github.com/ftchirou/faical.dev">my personal blog</a> where I will be writing about Swift, software engineering best practices, books I read, and anything I happen to be learning or be obsessed about at the moment.</p><p>Feel free to connect with me on Twitter <a href="https://twitter.com/ftchirou">@ftchirou</a> and subscribe to my <a href="https://rss.app/feeds/tPWkcHnpdDcjdOtB.xml">RSS feed</a> to get the latest updates on this blog.</div></div>\(latestArticlesDivTag(articles))</body></html>
        """
    }
